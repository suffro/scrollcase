...
[The Box Format](/v2/reference/box-format#signed-documents).
...
manifest](/v2/reference/box-format#revocations-manifest) for that; publishing and serving it belongs
