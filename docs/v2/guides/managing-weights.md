...
[`scrollcase refresh`](/v2/reference/cli#refresh) recomputes a pin after a reviewed change.
...
Then read [Offline / Air-Gapped Installs](/v2/guides/offline-airgap) to understand what you gave up.
