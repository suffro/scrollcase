...
[base scroll](/v2/reference/scroll#one-box-several-targets), with `cudaVersion`,
...
[split scroll](/v2/reference/scroll#one-box-several-targets) is for: the base holds the identity, the
...
See [Managing Model Weights](/v2/guides/managing-weights#keeping-the-box-small) for the general
