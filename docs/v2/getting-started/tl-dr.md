...
1. run `npm install -g scrollcase` to install the [CLI](/v2/reference/cli)
...
4. review the selected [scroll](/v2/reference/scroll)
...
7. generate or configure the [signing key](/v2/guides/signing-and-custody)
